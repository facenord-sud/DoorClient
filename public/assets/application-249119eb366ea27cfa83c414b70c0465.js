...
(function() {
  $(function() {
    $("a[use_url]").click(function() {
      return $('#door_uri').val($(this).attr('use_url'));
    });
    return $('.show-door').click(function() {
      return history.pushState('', null, this.href);
    });
  });

  $(function() {
    return $('#lock_state').change(function() {
      var val;
      val = $('#lock_state').val();
      if (val === '') {
        return;
      }
      return $('#new_lock').submit();
    });
  });

  $(function() {
    return $('#open_state').change(function() {
      var val;
      val = $('#open_state').val();
      if (val === '') {
        return;
      }
      return $('#new_open').submit();
    });
  });
